...
while True: 
    ...
    if user_choice == "1":  # Ajouter un élément
        ...
        item = input("Entrez le nom d'un élément à retirer à la liste de courses : ")
        if item in LISTE : 
          LISTE.remove(item)
    ...
    elif user_choice == "3":  # Afficher les éléments de la liste de courses.
        if LISTE : 
    ...
    elif user_choice == "4":  # Vider la liste de courses.
        LISTE.Clear()
